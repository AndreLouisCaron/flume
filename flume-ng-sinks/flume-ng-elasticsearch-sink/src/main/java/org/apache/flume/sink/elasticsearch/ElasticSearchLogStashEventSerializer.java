...
public class ElasticSearchLogStashEventSerializer implements
  ...
  private static final String ID_HEADER_NAME = "idHeaderName";
  ...
  private void appendHeaders(XContentBuilder builder, Event event)
    ...
    if (idHeaderName != null) {
      ...
      ContentBuilderUtil.appendField(builder, "_id", id.getBytes(charset));
    }
  ...
  public void configure(Context context) {
    if (StringUtils.isNotBlank(context.getString(ID_HEADER_NAME))) {
      this.idHeaderName = context.getString(ID_HEADER_NAME);
    }
  }
